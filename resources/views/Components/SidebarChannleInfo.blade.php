    ...
    <div class="position-sticky top-0">
        <div class="text-center pt-5">
            ...
            <div id="account-menu" class="list-group list-group-flush collapse d-md-block">
                <a href="account-notifications.html" class="list-group-item list-group-item-action d-flex align-items-center {{ Request::is('account-notifications') ? 'active' : '' }}">
                    <i class="bx bx-chalkboard fs-xl opacity-60 me-2"></i>
                    Канал
                </a>
                <a class="list-group-item list-group-item-action d-flex align-items-center {{ Request::is('my/channle/*/createPost') ? 'active' : '' }}">
                    <i class="bx bx-menu-alt-left fs-xl opacity-60 me-2"></i>
                    Создать пост
                </a>
            </div>
        </div>
