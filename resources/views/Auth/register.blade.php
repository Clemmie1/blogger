...
<head>
    <meta charset="utf-8">
    <title>Blogger | Зарегистрироваться</title>
    ...
    <section class="position-relative h-100 pt-5 pb-4">
        ...
        <div class="container d-flex flex-wrap justify-content-center justify-content-xl-start h-100 pt-5">
            <div class="w-100 align-self-end pt-1 pt-md-4 pb-4" style="max-width: 526px;">
                <h1 class="text-center text-xl-start">Зарегистрироваться</h1>
                <p class="text-center text-xl-start pb-3 mb-3">У вас уже есть аккаунт? <a href="{{route('auth.login')}}">Войдите здесь.</a></p>
