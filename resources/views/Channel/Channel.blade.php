<html lang="en" class="dark-mode"><head>
    ...
    <!-- Theme mode -->
    <script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-WKV3GT5"></script><script>
    ...
    <section class="container pt-5">
        <div class="row">
            ...
            <aside class="col-lg-3 col-md-4 border-end pb-5 mt-n5">
                @livewire('channel.load-aside-info', [
                    'channelID' => $infoChannle->id,
                ])
            </aside>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Спиок подписчиков</h5>
                <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                @livewire('channel.load-subscribers-list', [
                    'channelID' => $infoChannle->id,
                ])
            </div>
        </div>
